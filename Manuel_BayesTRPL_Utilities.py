...
def open_log_file(data_folder_trpl, trace_file):
    ...
    reabs_option = log_info[1][0]
    laserpower_file = log_info[2][0]
    

    return spacing, reabs_option, laserpower_file


def Bayes_TRPL_Utils(data_folder_trpl, trace_file):

    spacing, reabs_option, laserpower_file = open_log_file(data_folder_trpl, trace_file)
    ...
    print('Files ready...')
    return df, pile_up, sample_name, Fluence, Thickness, Surface, Absorption_coeff, Reflectance, intensity, amax, one_sun_carrier_density, spacing, reabs_option
